...
| `airflow_rotation` | `GET …/check-fan-rotation-direction` | `CLOCKWISE`, `COUNTERCLOCKWISE` (été / hiver) |
...
- `POST …/change-airflow-mode` — body `{"value": "MANUAL"|"BREEZE"}`, expect `202` or `204`
- `POST …/change-fan-rotation-direction` — body `{"value": "CLOCKWISE"|"COUNTERCLOCKWISE"}`, expect `202` or `204`
